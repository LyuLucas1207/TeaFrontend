...
import '../../css/components/TruckLoader.css';

function TruckLoader() {
    return (
        <div className="truck-loader_loader">
            <div className="truck-loader_truckWrapper">
                <div className="truck-loader_truckBody">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" className="truck-loader_trucksvg">
                ...
                <div className="truck-loader_truckTires">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="truck-loader_tiresvg">
                ...
                <div className="truck-loader_road"></div>

                <svg viewBox="0 0 453.459 453.459" xmlns="http://www.w3.org/2000/svg" id="Capa_1" version="1.1" fill="#000000" className="truck-loader_lampPost">
                    <path
