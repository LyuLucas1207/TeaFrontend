...
//!=========================================================================================================
//*这段代码的目的是在 Webpack 开发环境中启用热更新 (Hot Module Replacement, HMR)，以便在不重新加载整个页面的情况下应用代码的更改
  ...
  return {
    ...
    */
    ...
    entry: {
      ...
      admin_home: isEnvDevelopment && !shouldUseReactRefresh ? [webpackDevClientEntry, paths.adminHomeIndexJs,] : paths.adminHomeIndexJs,
    },
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
            inject: true,
            chunks: ['admin_home'],
            template: paths.adminHomeHtml,
            filename: 'admin_home.html'
          },
          isEnvProduction
          ? {
                minify: {
